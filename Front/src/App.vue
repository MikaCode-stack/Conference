...
// Dark mode disabled for now — defaulting to light mode until the theming is redone.
...
<template>
  ...
  >
    ...
    <div class="flex items-center gap-3">
      ...
      <!-- Dark mode toggle disabled for now — defaulting to light mode until the theming is redone.
      <button
        type="button"
        class="rounded border border-gray-200 px-2 py-1 text-sm text-gray-600 hover:text-gray-950 dark:border-gray-800 dark:text-gray-400 dark:hover:text-gray-100"
        @click="toggleTheme"
